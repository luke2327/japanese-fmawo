  ...
  return (
    <div>
      ...
      <div className="mb-4">
        ...
        <p>
          일본에서는 일반적으로 ‘아호(바보)’가 ‘바카(바보)’보다 강한 느낌. 단지
          오사카를 중심으로 한 간사이 지방에서는 반대로, ‘바카’가 ‘아호’보다
          강한 느낌입니다. 오사카 사람은 흔히 아호 아호라고 합니다만, 실제로는
          한국의 멍청이와 같은 가벼운 표현이에요. 반대로 오사카 사람에게
          ‘바카(바보)’라고 하면, 꽤 심한 말이 됩니다. 또 오사카 이외의 타 지역
          사람들이 ‘아호’라는 말을 들으면 상처받는 경우도 있습니다.
        </p>
