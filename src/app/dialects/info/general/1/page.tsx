    ...
    <div>
      ...
      <div className="relative z-10 bg-white dark:bg-[#111010]">
        ...
        <p className="mb-4">
          ...
          로마법을 따르라. 누구나 한 번쯤 들어보는 유명한 경구들이죠. 하지만
          일본 속담은 좀처럼 들어본 적이 없습니다. 그래서 이번에는 유명한 일본
          속담 20가지와 그 뜻을 소개하려 합니다!
        </p>
        <p className="mb-4">
        ...
        <hr className="mt-2 mb-4"></hr>
        <p className="mb-4">
          여러 가지로 해석될 수 있는 속담입니다. {'"'}요메{'"'}라는 단어는
          신부로 읽힐 수도, 며느리로 읽힐 수도 있기 때문이죠. 가을 가지는 맛이
          좋기 때문에 필연적인 고부갈등을 의미하는 속담으로도 쓰이고, 가지를
          너무 많이 먹으면 병이 날 수 있어 며느리(신부)가 먹지 않도록 해
          보호하는 지혜로운 시어머니라는 의미도 있습니다.
        </p>
        <h2 className="text-xl">
        ...
        <hr className="mt-2 mb-4"></hr>
        <p className="mb-4">
          모든 결점을 숨겼다고 생각하지만, 일부만 보이지 않을 뿐 다른 이들이
          모두 문제를 눈치 챘는데도 모든 것이 잘 되고 있는 양 행동하는 것을
          의미합니다.
        </p>
        <h2 className="text-xl">3. 지나간 축제(後の祭り)</h2>
        <hr className="mt-2 mb-4"></hr>
        <p className="mb-4">
          직역하면 {'"'}너무 늦었다{'"'}는 의미로, 뒤늦게 무엇인가를 후회하는
          것은 시간 낭비라는 의미입니다. 마쓰리는 신도 신사나 불교 사찰에서
          열리는 축제로 즐거움과 관련되어 쓰입니다.
        </p>
        ...
        <hr className="mt-2 mb-4"></hr>
        <p className="mb-4">
          아무리 튼튼한 돌 소재의 다리라도 구조가 약해지면서 무너질 수 있으니
          언뜻 보기에 안전해 보여도 항상 주의를 기울여야 한다는 의미입니다.
        </p>
      </div>
    </div>
  );
